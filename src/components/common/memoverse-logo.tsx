...
export function MemoVerseLogo({ className = "w-8 h-8", textClassName = "" }: { className?: string; textClassName?: string }) {
  return (
    <div className="flex items-center gap-3">
      <div className="relative shrink-0 flex items-center justify-center">
        ...
        >
          <defs>
            <linearGradient id="memoverseGold" x1="0%" y1="0%" x2="100%" y2="100%">
